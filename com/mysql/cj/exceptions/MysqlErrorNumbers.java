...
public final class MysqlErrorNumbers
{
    ...
    public static String get(final String stateCode) {
        return MysqlErrorNumbers.sqlStateMessages.get(stateCode);
    }
    
    public static String mysqlToSql99(final int errno) {
        final Integer err = errno;
        if (MysqlErrorNumbers.mysqlToSql99State.containsKey(err)) {
            return MysqlErrorNumbers.mysqlToSql99State.get(err);
        }
        return "HY000";
    }
    
    public static String mysqlToSqlState(final int errno) {
    ...
    static {
        (MysqlErrorNumbers.sqlStateMessages = new HashMap<String, String>()).put("01002", Messages.getString("SQLError.35"));
        MysqlErrorNumbers.sqlStateMessages.put("01004", Messages.getString("SQLError.36"));
        MysqlErrorNumbers.sqlStateMessages.put("01006", Messages.getString("SQLError.37"));
        MysqlErrorNumbers.sqlStateMessages.put("01S00", Messages.getString("SQLError.38"));
        MysqlErrorNumbers.sqlStateMessages.put("01S01", Messages.getString("SQLError.39"));
        MysqlErrorNumbers.sqlStateMessages.put("01S03", Messages.getString("SQLError.40"));
        MysqlErrorNumbers.sqlStateMessages.put("01S04", Messages.getString("SQLError.41"));
        MysqlErrorNumbers.sqlStateMessages.put("07001", Messages.getString("SQLError.42"));
        MysqlErrorNumbers.sqlStateMessages.put("08001", Messages.getString("SQLError.43"));
        MysqlErrorNumbers.sqlStateMessages.put("08002", Messages.getString("SQLError.44"));
        MysqlErrorNumbers.sqlStateMessages.put("08003", Messages.getString("SQLError.45"));
        MysqlErrorNumbers.sqlStateMessages.put("08004", Messages.getString("SQLError.46"));
        MysqlErrorNumbers.sqlStateMessages.put("08007", Messages.getString("SQLError.47"));
        MysqlErrorNumbers.sqlStateMessages.put("08S01", Messages.getString("SQLError.48"));
        MysqlErrorNumbers.sqlStateMessages.put("21S01", Messages.getString("SQLError.49"));
        MysqlErrorNumbers.sqlStateMessages.put("22003", Messages.getString("SQLError.50"));
        MysqlErrorNumbers.sqlStateMessages.put("22008", Messages.getString("SQLError.51"));
        MysqlErrorNumbers.sqlStateMessages.put("22012", Messages.getString("SQLError.52"));
        MysqlErrorNumbers.sqlStateMessages.put("40001", Messages.getString("SQLError.53"));
        MysqlErrorNumbers.sqlStateMessages.put("28000", Messages.getString("SQLError.54"));
        MysqlErrorNumbers.sqlStateMessages.put("42000", Messages.getString("SQLError.55"));
        MysqlErrorNumbers.sqlStateMessages.put("42S02", Messages.getString("SQLError.56"));
        MysqlErrorNumbers.sqlStateMessages.put("S0001", Messages.getString("SQLError.57"));
        MysqlErrorNumbers.sqlStateMessages.put("S0002", Messages.getString("SQLError.58"));
        MysqlErrorNumbers.sqlStateMessages.put("S0011", Messages.getString("SQLError.59"));
        MysqlErrorNumbers.sqlStateMessages.put("S0012", Messages.getString("SQLError.60"));
        MysqlErrorNumbers.sqlStateMessages.put("S0021", Messages.getString("SQLError.61"));
        MysqlErrorNumbers.sqlStateMessages.put("S0022", Messages.getString("SQLError.62"));
        MysqlErrorNumbers.sqlStateMessages.put("S0023", Messages.getString("SQLError.63"));
        MysqlErrorNumbers.sqlStateMessages.put("S1000", Messages.getString("SQLError.64"));
        MysqlErrorNumbers.sqlStateMessages.put("S1001", Messages.getString("SQLError.65"));
        MysqlErrorNumbers.sqlStateMessages.put("S1002", Messages.getString("SQLError.66"));
        MysqlErrorNumbers.sqlStateMessages.put("S1009", Messages.getString("SQLError.67"));
        MysqlErrorNumbers.sqlStateMessages.put("S1C00", Messages.getString("SQLError.68"));
        MysqlErrorNumbers.sqlStateMessages.put("S1T00", Messages.getString("SQLError.69"));
        (MysqlErrorNumbers.mysqlToSql99State = new HashMap<Integer, String>()).put(1249, "01000");
        MysqlErrorNumbers.mysqlToSql99State.put(1261, "01000");
        MysqlErrorNumbers.mysqlToSql99State.put(1262, "01000");
        MysqlErrorNumbers.mysqlToSql99State.put(1265, "01000");
        MysqlErrorNumbers.mysqlToSql99State.put(1263, "22004");
        MysqlErrorNumbers.mysqlToSql99State.put(1264, "22003");
        MysqlErrorNumbers.mysqlToSql99State.put(1311, "01000");
        MysqlErrorNumbers.mysqlToSql99State.put(1642, "01000");
        MysqlErrorNumbers.mysqlToSql99State.put(1329, "02000");
        MysqlErrorNumbers.mysqlToSql99State.put(1643, "02000");
        MysqlErrorNumbers.mysqlToSql99State.put(1040, "08004");
        MysqlErrorNumbers.mysqlToSql99State.put(1251, "08004");
        MysqlErrorNumbers.mysqlToSql99State.put(1042, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1043, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1047, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1053, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1080, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1081, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1152, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1153, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1154, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1155, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1156, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1157, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1158, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1159, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1160, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1161, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1184, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1189, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1190, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1218, "08S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1312, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1314, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1335, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1336, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1415, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1845, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1846, "0A000");
        MysqlErrorNumbers.mysqlToSql99State.put(1044, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1049, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1055, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1056, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1057, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1059, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1061, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1063, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1064, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1065, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1066, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1067, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1068, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1069, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1070, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1071, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1072, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1073, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1074, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1075, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1083, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1084, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1090, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1091, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1101, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1102, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1103, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1104, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1106, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1107, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1110, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1112, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1113, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1115, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1118, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1120, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1121, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1131, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1132, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1133, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1139, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1140, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1141, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1142, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1143, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1144, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1145, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1147, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1148, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1149, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1162, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1163, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1164, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1166, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1167, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1170, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1171, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1172, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1173, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1176, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1177, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1178, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1203, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1211, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1226, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1227, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1230, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1231, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1232, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1234, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1235, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1239, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1248, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1250, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1252, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1253, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1280, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1281, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1286, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1304, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1305, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1308, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1309, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1310, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1313, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1315, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1316, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1318, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1319, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1320, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1322, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1323, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1324, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1327, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1330, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1331, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1332, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1333, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1337, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1338, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1370, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1403, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1407, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1410, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1413, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1414, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1425, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1426, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1427, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1437, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1439, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1453, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1458, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1460, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1461, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1463, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1582, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1583, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1584, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1630, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1641, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1687, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1701, "42000");
        MysqlErrorNumbers.mysqlToSql99State.put(1222, "21000");
        MysqlErrorNumbers.mysqlToSql99State.put(1241, "21000");
        MysqlErrorNumbers.mysqlToSql99State.put(1242, "21000");
        MysqlErrorNumbers.mysqlToSql99State.put(1022, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1048, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1052, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1062, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1169, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1216, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1217, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1451, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1452, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1557, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1586, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1761, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1762, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1859, "23000");
        MysqlErrorNumbers.mysqlToSql99State.put(1406, "22001");
        MysqlErrorNumbers.mysqlToSql99State.put(1416, "22003");
        MysqlErrorNumbers.mysqlToSql99State.put(1690, "22003");
        MysqlErrorNumbers.mysqlToSql99State.put(1292, "22007");
        MysqlErrorNumbers.mysqlToSql99State.put(1367, "22007");
        MysqlErrorNumbers.mysqlToSql99State.put(1441, "22008");
        MysqlErrorNumbers.mysqlToSql99State.put(1365, "22012");
        MysqlErrorNumbers.mysqlToSql99State.put(1325, "24000");
        MysqlErrorNumbers.mysqlToSql99State.put(1326, "24000");
        MysqlErrorNumbers.mysqlToSql99State.put(1179, "25000");
        MysqlErrorNumbers.mysqlToSql99State.put(1207, "25000");
        MysqlErrorNumbers.mysqlToSql99State.put(1045, "28000");
        MysqlErrorNumbers.mysqlToSql99State.put(1698, "28000");
        MysqlErrorNumbers.mysqlToSql99State.put(1873, "28000");
        MysqlErrorNumbers.mysqlToSql99State.put(1758, "35000");
        MysqlErrorNumbers.mysqlToSql99State.put(1046, "3D000");
        MysqlErrorNumbers.mysqlToSql99State.put(1645, "0K000");
        MysqlErrorNumbers.mysqlToSql99State.put(1887, "0Z002");
        MysqlErrorNumbers.mysqlToSql99State.put(1339, "20000");
        MysqlErrorNumbers.mysqlToSql99State.put(1058, "21S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1136, "21S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1138, "22004");
        MysqlErrorNumbers.mysqlToSql99State.put(1903, "2201E");
        MysqlErrorNumbers.mysqlToSql99State.put(1568, "25001");
        MysqlErrorNumbers.mysqlToSql99State.put(1792, "25006");
        MysqlErrorNumbers.mysqlToSql99State.put(1303, "2F003");
        MysqlErrorNumbers.mysqlToSql99State.put(1321, "2F005");
        MysqlErrorNumbers.mysqlToSql99State.put(1050, "42S01");
        MysqlErrorNumbers.mysqlToSql99State.put(1051, "42S02");
        MysqlErrorNumbers.mysqlToSql99State.put(1109, "42S02");
        MysqlErrorNumbers.mysqlToSql99State.put(1146, "42S02");
        MysqlErrorNumbers.mysqlToSql99State.put(1082, "42S12");
        MysqlErrorNumbers.mysqlToSql99State.put(1060, "42S21");
        MysqlErrorNumbers.mysqlToSql99State.put(1054, "42S22");
        MysqlErrorNumbers.mysqlToSql99State.put(1247, "42S22");
        MysqlErrorNumbers.mysqlToSql99State.put(1317, "70100");
        MysqlErrorNumbers.mysqlToSql99State.put(1037, "HY001");
        MysqlErrorNumbers.mysqlToSql99State.put(1038, "HY001");
        MysqlErrorNumbers.mysqlToSql99State.put(1402, "XA100");
        MysqlErrorNumbers.mysqlToSql99State.put(1614, "XA102");
        MysqlErrorNumbers.mysqlToSql99State.put(1613, "XA106");
        MysqlErrorNumbers.mysqlToSql99State.put(1401, "XAE03");
        MysqlErrorNumbers.mysqlToSql99State.put(1397, "XAE04");
        MysqlErrorNumbers.mysqlToSql99State.put(1398, "XAE05");
        MysqlErrorNumbers.mysqlToSql99State.put(1399, "XAE07");
        MysqlErrorNumbers.mysqlToSql99State.put(1440, "XAE08");
        MysqlErrorNumbers.mysqlToSql99State.put(1400, "XAE09");
        MysqlErrorNumbers.mysqlToSql99State.put(1205, "40001");
        MysqlErrorNumbers.mysqlToSql99State.put(1213, "40001");
    }
}
